...
namespace AlinaKrossManager.BuisinessLogic.Services.Instagram
{
	public partial class InstagramService : SocialBaseService
	{
		...
		{
			return "Создай текстовое сопровождение для поста в Instagram на основе предоставленного изображения." +
				"Следуй этим шагам:" +
				"1. Описание: Придумай красивое и краткое и флиртующее описание на английском языке для поста девушкой моелью. Можно добавить 1-3 релевантных эмодзи. Ориентируйся на содержание изображения." +
				"2. Хештеги: Придумай список из не более 15 хештегов. Хештеги должны отражать содержание изображения. В их число обязательно включи 2-3 хештега, указывающих на AI-контент (например, #aiart, #aigenerated, #digitalart, #aiartist)." +
				"3. Формат ответа: Предоставь ответ строго в следующем виде: Сначала — описание. Через одну пустую строку — хештеги. Никаких дополнительных пояснений, уточнений, кавычек или слов вроде \"Описание:\" или \"Хештеги:\"." +
				"Пример корректного формата ответа: ✨ A moment of pure serenity in the digital dreamscape.\r\n\r\n#aiart #digitaldream #futureaesthetic #aigenerated #cyberzen." +
