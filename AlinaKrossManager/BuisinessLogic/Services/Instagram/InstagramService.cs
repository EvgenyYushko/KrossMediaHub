...
namespace AlinaKrossManager.BuisinessLogic.Services.Instagram
{
	public partial class InstagramService : SocialBaseService
	{
		...
		{
			return $@"Создай текстовое, красивое, интригующее и флиртующее сопровождение для поста в Instagram на основе предоставленного изображения, где изображена красивая девушка модель.

				Следуй этим шагам:
				1.  Описание: Придумай красивое и краткое описание на английском языке для поста. Можно добавить 1-3 релевантных эмодзи. Ориентируйся на содержание изображения.
