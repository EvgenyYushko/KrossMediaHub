		...
		public async override Task Execute(IJobExecutionContext context)
		{
			try
			{
				using (var scope = _serviceScopeFactory.CreateScope())
				{
					...
					var textToTg = await _generativeLanguageModel.GeminiRequest(promptRus(topic));
