...
namespace AlinaKrossManager.Jobs
{
	...
	public class XDailyJob : SchedulerJob
	{
		...
		// по чётным дням 
		public static string Time => "0 57 10 2-31/2 * ?";
