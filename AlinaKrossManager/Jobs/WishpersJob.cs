		...
		public override async Task Execute(IJobExecutionContext context)
		{
			try
			{
				using (var scope = _serviceScopeFactory.CreateScope())
				{
					...
					var sampleContext = "Тихий, тёплый и бархатный голос, говорит очень интимно";
						//"Придумай ОДНУ короткую название сцены для эротического голосового сообщения Алины Кросс. \" +\r\n\"Верни ТОЛЬКО название сцены, без каких-либо дополнительных объяснений, описаний и кавычек. \" +\r\n\"Название должно быть в стиле: 'Имитация секса по телефону', 'Лежит на диване', 'В горячей ванне' и т.д. \" +\r\n\"Каждый раз придумывай разную сцену. Делай вариации обстановки и позы.";
					var promt = "Придумай небольшое предложение (4-10 слов) для голосового сообщения на русском языке. " +
